...
export class DashboardComponent implements OnInit {
  ...
  totaldashboardUsercount:any
  constructor(public dashboardService:DashboardService,public toastService: ToastService,private toastr: ToastrService) {
    var date = new Date();
  ...
  getAll() {
    ...
    this.dashboardService.getAll().subscribe(
       (res: any) => {
          // this.spinner.hide();
          if (res.success) {
            this.totaldashboardUsercount = res.data;
