...
export class AddUserComponent {
  ...
  loadForm() {
    this.formGrouptt = this.fb.group({
      ...
      email: [this.User.email, Validators.compose([Validators.required, Validators.pattern(/^[^\s@]+@[^\s@]+\.[^\s@]+$/)],)],
      mobileNo: [this.User.mobileNo, Validators.compose([Validators.required])],
